...
export default (req, res) => {
    ...
    res.json([
        ...
        { fa: faCalendarDay, details: "23 years" },
        ...
        { fa: faBullseye, details: "I live for the pursuit of knowledge and to solve problems" },
        {
            fa: faUserTag,
            ...
            Problem-solving is a particular interest of mine,
