...
function Browser(props) {
        ...
        return (
            <div className={styles.browser}>
                <div className={styles.nav}>
                    ...
                    <span className={styles.cancel} onClick={setWindowActive.bind(this, false)} >x</span>
                </div>
    ...
    const Icon = () =>{
        return(
            <div onClick={setWindowActive.bind(this, true)} className={styles.background}>
                <img src="/brand/logo.svg" alt="Paa-Kofi Aidoo" className={styles.backIcon}/>
                <p>Paa-Kofi Aidoo</p>
            </div>
        )
	...
	return (
		<div>
			{window.isActive?Window(props.children):Icon()}
		</div>
	);
}
